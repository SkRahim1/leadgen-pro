...
const categories = [
  { key: 'physiotherapists', name: 'Physiotherapist', industry: 'healthcare' },
  { key: 'driving-schools', name: 'Driving School', industry: 'education' }
];

const sleep = (ms) => new Promise(resolve => setTimeout(resolve, ms));

async function main() {
  console.log('=== Starting Incremental Scraper to Reach 500+ Leads ===');
  ...
  const targetLeads = 515; // Target at least 515 leads in total
  let newLeadsCount = 0;
  let totalRequests = 0;
